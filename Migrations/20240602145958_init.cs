        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyName = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    ...
                    MarketCap = table.Column<long>(type: "NUMBER(19)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StockId = table.Column<int>(type: "NUMBER(10)", nullable: true)
                },
                constraints: table =>
                {
